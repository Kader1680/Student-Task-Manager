...
<div class="flex items-center justify-center min-h-screen bg-blue-100">
    <div class="w-full max-w-2xl bg-white shadow-lg rounded-2xl p-8">
         ...
         <form action="{{ route('projects.tasks.store', $project) }}" method="POST" class="space-y-5">
            ...
            <div class="mb-4">
                <label for="reminder_at" class="block mb-1">Reminder At</label>
                <input type="datetime-local" name="reminder_at" class="w-full border rounded px-3 py-2" value="{{ old('reminder_at', isset($task) ? $task->reminder_at : '') }}">
            </div>
